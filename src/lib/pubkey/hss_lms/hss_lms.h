...
/*
TODO List:
 - Decide about the private key
 - Check treehash with Sphincs+
 - Check that HSS index fits in 64 bit

 Tests:
 - Test for exhausted key
 - Hash signatures in tests
 - Full list of OTS tests (possible?)
 - Process TODOs in tests
